...
#define cpu_map_h
  ...
  #define COOLANT_MIST_BIT   4  // Uno Analog Pin 4
    ...
    #define ECHO_STEP_PORT COOLANT_MIST_PORT
    #define ECHO_STEP_PIN COOLANT_MIST_BIT
    #define ECHO_STEP_MASK (1U<<ECHO_STEP_PIN)
    #define ECHO_DIRECTION_PORT COOLANT_FLOOD_PORT
    #define ECHO_DIRECTION_PIN COOLANT_FLOOD_BIT
